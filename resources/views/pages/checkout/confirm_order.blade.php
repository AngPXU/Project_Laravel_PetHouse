...
<div class="container" style="margin-left: 200px;margin-right: 100px;">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h2 style="text-align:center;font-size:23px;font-weight:600;">ĐƠN HÀNG ĐÃ ĐƯỢC XÁC NHẬN</h2>
      <hr style="width:60%;text-align:center;">
    </div>
    <div class="col-md-12">
      <p style="font-size:20px;padding:20px;">Chào bạn <span style="color:#fbaf32;padding-right:10px;">{{$shipping_array['customer_name']}}</span>.Chúng tôi đã xác nhận đơn hàng của bạn, thời gian giao hàng dự kiến sẽ là 4 ngày. Cảm ơn bạn đã mua hàng tại PetHouse </p>
    </div>
    <div class="column-row" style="padding-left:50px;">
        ...
        <p><b>Phí giao hàng:</b>&ensp;&nbsp;<span></span></p>
    </div>
    ...
    <div class="col-md-12">
      <p style="font-size:20px;padding:20px;">Nếu thông tin có gì sai sót xin liên hệ với chúng tôi tại website <span style="color:#fbaf32;">pethouse.com</span> hoặc số điện thoại <span style="color:#fbaf32;">0334301474</span>. Xin trâng trọng cảm ơn</p>
    </div>
  </div>
</div>
